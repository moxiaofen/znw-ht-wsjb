  ...
  />
    <div class="content">
      ...
      <div class='flex_space bber'>
        <input class='password' type="text" ref="rUserPwd" v-model="vUserPwd"  @keyup.enter='toLogin'
               placeholder="请输入密码" v-if="ifSetDisplay" oninput="if(value.length>12)value=value.slice(0,12)"/>
        <input class='password' type="password" ref="rUserPwd" v-model="vUserPwd"  @keyup.enter='toLogin'
